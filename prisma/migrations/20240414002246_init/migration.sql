...
INSERT INTO "new_User" ("address", "birth_date", "create_at", "email", "id", "idCompamy", "idProgram", "idTypeDocument", "idTypeMunicipality", "idTypeUser", "last_name", "name") SELECT "address", "birth_date", "create_at", "email", "id", "idCompamy", "idProgram", "idTypeDocument", "idTypeMunicipality", "idTypeUser", "last_name", "name" FROM "User";
DROP TABLE "User";
