...
INSERT INTO "new_User" ("address", "birth_date", "create_at", "email", "id", "idCompamy", "idProgram", "idTypeDocument", "idTypeMunicipality", "idTypeUser", "last_name", "name", "num_document", "token") SELECT "address", "birth_date", "create_at", "email", "id", "idCompamy", "idProgram", "idTypeDocument", "idTypeMunicipality", "idTypeUser", "last_name", "name", "num_document", "token" FROM "User";
DROP TABLE "User";
